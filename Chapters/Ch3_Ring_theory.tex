...
\end{corollary}
\newpage 
\begin{definition}[\textit{Rational functions in $X$ over $F$}]
...
\end{tcolorbox}
\begin{tcolorbox}
    We are briefly jumped ahead to some section 3.9 material from Hersteins book, we will now return to 3.7 material, I hope this wasn't too confusing...
\end{tcolorbox}
\newpage
