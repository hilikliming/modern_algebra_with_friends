...
\begin{selfcheckbox}{0.1}{sec:LogicalConnectives}
  ...
  \hypertarget{q:ch0:notation:4}{Q4.} \textit{Produce.} Using the vertical bar ``for which'' notation introduced in this section, write the set of integers $x$ with $22 \leq x < 27$. \sclink{a:ch0:notation:4}{answer}\par\smallskip
  ...
  \begin{enumerate}[(a),topsep=2pt,itemsep=0pt]
    ...
    \item $\exists \, x \in \Z \ni x + 5 = 0$
  \end{enumerate}
  \sclink{a:ch0:notation:5}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.3}{sec:axioms}
  ...
  \hypertarget{q:ch0:negations:3}{Q3.} \textit{Produce.} Write the negation of ``if it is raining, then the sidewalk is wet.'' \sclink{a:ch0:negations:3}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.4}{sec:BasicSetTheory}
  ...
  \hypertarget{q:ch0:axioms:5}{Q5.} \textit{[T/F]} The book treats ``set'' and ``integer'' as primitive notions: their existence and basic properties are taken as starting points and not derived from anything more fundamental. \sclink{a:ch0:axioms:5}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.7}{sec:ContrapositiveExample}
  ...
  \hypertarget{q:ch0:ineq:4}{Q4.} \textit{Produce.} Given $0 < 2 < 5$, write down the correct chain of inequalities between $0$, $\tfrac{1}{5}$, and $\tfrac{1}{2}$. Cite the rule from this section's table that justifies the ordering you chose. \sclink{a:ch0:ineq:4}{answer}
\end{selfcheckbox}
...
\noindent\hypertarget{a:ch0:ineq:4}{Q4.} $0 < \tfrac{1}{5} < \tfrac{1}{2}$. The Reciprocals rule on positive numbers reverses the order, so the larger original ($5$) yields the smaller reciprocal ($\tfrac{1}{5}$) and the smaller original ($2$) yields the larger reciprocal ($\tfrac{1}{2}$). The leading ``$0 <$'' survives because the same rule's first row says $a > 0 \implies \tfrac{1}{a} > 0$. \sclink{q:ch0:ineq:4}{back}\par\smallskip
