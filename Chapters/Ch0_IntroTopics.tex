...
\begin{selfcheckbox}{0.1}{sec:LogicalConnectives}
  ...
  \hypertarget{q:ch0:notation:3}{Q3.} \textit{[T/F]} The contrapositive of $A \implies B$ is $\lnot B \implies \lnot A$. \sclink{a:ch0:notation:3}{answer}\par\smallskip
  \hypertarget{q:ch0:notation:4}{Q4.} \textit{Produce.} Using the vertical bar ``for which'' notation introduced in this section, write the set of integers $x$ with $22 \leq x < 27$. \sclink{a:ch0:notation:4}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.2}{sec:NegatingConnectives}
  ...
  \hypertarget{q:ch0:truthtables:4}{Q4.} \textit{Produce.} Write a one-sentence ``for all'' statement that is vacuously true (so true by default, with nothing to check). \sclink{a:ch0:truthtables:4}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.5}{sec:ImportantSets}
  ...
  \hypertarget{q:ch0:sets:6}{Q6.} \textit{Produce.} Using set-builder notation, write the Cartesian product $A \times B$ for arbitrary sets $A$ and $B$. \sclink{a:ch0:sets:6}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.6}{sec:ManipulatingInequalities}
  ...
  \hypertarget{q:ch0:impsets:3}{Q3.} \textit{Produce.} Write the set of real numbers $r$ satisfying $-3 \leq r < 5$ in interval notation. \sclink{a:ch0:impsets:3}{answer}
\end{selfcheckbox}
...
\begin{selfcheckbox}{0.7}{sec:ContrapositiveExample}
  ...
  \hypertarget{q:ch0:ineq:4}{Q4.} \textit{Produce.} Starting from $0 < 2 < 5$, write down the chain of inequalities you get by taking reciprocals of the two positive numbers. \sclink{a:ch0:ineq:4}{answer}
\end{selfcheckbox}
...
\noindent\hypertarget{a:ch0:notation:3}{Q3.} T. This is the definition of the contrapositive; in classical logic, $A \implies B$ and $\lnot B \implies \lnot A$ are logically equivalent. \sclink{q:ch0:notation:3}{back}\par\smallskip
...
\noindent\hypertarget{a:ch0:truthtables:4}{Q4.} Example: ``All of my motorcycles are purple,'' when you own no motorcycles; or ``Every element of $\emptyset$ is a number.'' Both are universal statements whose domains are empty, so each holds by default. \sclink{q:ch0:truthtables:4}{back}\par\smallskip
...
\noindent\hypertarget{a:ch0:axioms:4}{Q4.} Division: $1 / 2 \notin \Z$. (The four facts list $+$, $-$, additive-inverse existence, and $\cdot$; division is conspicuously absent. Division of two integers can land outside $\Z$, as the $1/2$ example shows.) \sclink{q:ch0:axioms:4}{back}\par\smallskip
...
\noindent\hypertarget{a:ch0:ineq:4}{Q4.} $0 < \tfrac{1}{5} < \tfrac{1}{2}$. Reciprocals of positive numbers reverse the ordering: the smaller of $2$ and $5$ (which is $2$) gives the larger reciprocal ($\tfrac{1}{2}$), and the larger of the two ($5$) gives the smaller positive reciprocal ($\tfrac{1}{5}$). \sclink{q:ch0:ineq:4}{back}\par\smallskip
...
\noindent\hypertarget{a:ch0:contra:1}{Q1.} T. That is the definition: assume $A \land \lnot B$, derive $\Rightarrow \Leftarrow$, conclude $A \implies B$. \sclink{q:ch0:contra:1}{back}\par\smallskip
...
\noindent\hypertarget{a:ch0:whyinduction:3}{Q3.} If $P$ failed at any $n$, there would have to be a smallest such $n$, because any non-empty collection of natural numbers starting at $N$ has a smallest member (this is a property of how the natural numbers are ordered). So ruling out ``there is a smallest failure'' rules out ``there is any failure'' at all; the failure set is empty, and $P$ holds for every $n \geq N$. \sclink{q:ch0:whyinduction:3}{back}\par\smallskip
