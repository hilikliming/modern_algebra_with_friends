...
\begin{table}[h!]
    ...
    \begin{tabular}{c||c|c|c|c|}
         ...
         e&$e\cdot e$&$e\cdot a$&$e\cdot b$f&$e\cdot c$  \\ \hline
...
% Table listing the divisors of 6 (order of the group) and the occurence of that divisor as order of one of the elements a \in G. (Working up to Lagrange's Thm looking at finite Cyclic Groups and Subgroups.)
\begin{table}[h!]
    \centering
...
\end{center}
% \begin{align}
%     o(G) = p \overset{\text{Lagrange Cor. \#5}}{\implies} \ G \text{ is cyclic and has no non-trivial subgroups }\implies G \text{ is simple} \implies G \text{ abelian}.
% \end{align}
