...
% bibliography.bib is loaded via \addbibresource in main.tex
...
\newcommand{\exampleTname}{Example}
...
\if\relax\detokenize{#1}\relax\else{\sffamily\bfseries #1.\space}\fi% Optional title in bold sf, period and space, before body
